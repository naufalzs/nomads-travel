                ...
                <form action="{{ route('travel-package.update', $item->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="about" id="about" rows="10"
                            class="form-control d-block w-100">{{ $item->about }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="featured_event">Featured Event</label>
                        <input class="form-control" type="text" id="featured_event" name="featured_event"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="foods" name="foods" placeholder="Foods"
                            value="{{ $item->foods }}">
                    </div>
                    <div class="form-group">
